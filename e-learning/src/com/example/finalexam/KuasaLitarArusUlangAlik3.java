...
public class KuasaLitarArusUlangAlik3 extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.litararusulangalik2);
	...
	//	wv.getSettings().setBuiltInZoomControls(true);
		...
		String data = "<body>" + "<img src=\"images/aras2_18.jpg\"/></body>";
		...
		menu.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(KuasaLitarArusUlangAlik3.this, Menu_Utama.class);
		...
		aras.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(KuasaLitarArusUlangAlik3.this, Aras2.class);
		...
		kedepan.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(KuasaLitarArusUlangAlik3.this,KuasaLitarArusUlangAlik4.class);
		...
		kebelakang.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(KuasaLitarArusUlangAlik3.this,KuasaLitarArusUlangAlik2.class);

...
public class Jenis_getlogik1 extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.jenis_getlogik1);
	...
	//	wv.getSettings().setBuiltInZoomControls(true);
		...
		String data = "<body>" + "<img src=\"images/getlogik3.jpg\"/></body>";
		...
		menu.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(Jenis_getlogik1.this, Menu_Utama.class);
		...
		aras.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(Jenis_getlogik1.this, Aras1.class);
		...
		kedepan.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(Jenis_getlogik1.this,Jenis_getlogik2.class);
			 ...
			 public void onClick(View v )
			   {
				...
				Intent i = new Intent(Jenis_getlogik1.this,Jenis_getlogik.class);

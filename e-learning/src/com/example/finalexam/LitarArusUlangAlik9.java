...
public class LitarArusUlangAlik9 extends Activity implements OnClickListener {
	...
	//	wv.getSettings().setBuiltInZoomControls(true);
		...
		String data = "<body>" + "<img src=\"images/aras2_9.jpg\"/></body>";
		...
		menu.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(LitarArusUlangAlik9.this, Menu_Utama.class);
		...
		aras.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(LitarArusUlangAlik9.this, Aras2.class);
		...
		kedepan.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(LitarArusUlangAlik9.this,LitarArusUlangAlik10.class);
		...
		kebelakang.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(LitarArusUlangAlik9.this,LitarArusUlangAlik8.class);

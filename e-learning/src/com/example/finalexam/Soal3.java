...
public class Soal3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jawab.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// dialog
				AlertDialog.Builder dialog = new AlertDialog.Builder(Soal3.this);
				...
				if (id == -1) {
					...
					ourSound=MediaPlayer.create(Soal3.this, R.raw.button);
					ourSound.start();
				...
				// ada radio yang dicek
					...
					if (id == R.id.opsi3) {
						// intent
						final Intent intent = new Intent(Soal3.this, Soal4.class);
						
						// penjelasan
						dialog.setTitle("Benar");
						dialog.setMessage("Taniah, jawapan anda betul");
						ourSound = MediaPlayer.create(Soal3.this, R.raw.musik);
						ourSound.start();
					...
					// salah
						...
						ourSound=MediaPlayer.create(Soal3.this, R.raw.error);
						ourSound.start();
						dialog.setPositiveButton("Mula Semula", new OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								ourSound=MediaPlayer.create(Soal3.this, R.raw.button);
								ourSound.start();
								final Intent i = new Intent(Soal3.this, Soal1.class);
								startActivity(i);	
								finish();
							}});
						dialog.show();
    	...
    	if(keycode==KeyEvent.KEYCODE_BACK){
    		...
    		dialog.setPositiveButton("Tamatkan",new OnClickListener(){
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					ourSound=MediaPlayer.create(Soal3.this, R.raw.button);
					ourSound.start();
					final Intent intent=new Intent(Soal3.this,Kuiz.class);
					startActivity(intent);
					finish();
				}

...
public class Soal5_2 extends Activity {
MediaPlayer ourSound;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.soal5_2);
        ...
        jawab.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// dialog
				AlertDialog.Builder dialog = new AlertDialog.Builder(Soal5_2.this);
				...
				if (id == -1) {
					...
					ourSound=MediaPlayer.create(Soal5_2.this, R.raw.button);
					ourSound.start();
				...
				// ada radio yang dicek
					...
					if (id == R.id.opsi2) {						
						// penjelasan
						final Intent intent = new Intent(Soal5_2.this, Kuiz.class);
						dialog.setTitle("Tamat");
						dialog.setMessage("Jawapan anda betul. Taniah anda berjaya menjawab kesemua soalan");
						ourSound = MediaPlayer.create(Soal5_2.this, R.raw.musik);
						ourSound.start();
					...
					// salah
						...
						ourSound=MediaPlayer.create(Soal5_2.this, R.raw.error);
						ourSound.start();
						dialog.setPositiveButton("Mula Semula", new OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								ourSound=MediaPlayer.create(Soal5_2.this, R.raw.button);
								ourSound.start();
								final Intent i = new Intent(Soal5_2.this, Soal1.class);
								startActivity(i);	
								finish();
							}});
						dialog.show();

...
public class Ff6 extends Activity implements OnClickListener {
	...
	//	wv.getSettings().setBuiltInZoomControls(true);
		...
		String data = "<body>" + "<img src=\"images/ff6.jpg\"/></body>";
		...
		menu.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(Ff6.this, Menu_Utama.class);
		...
		aras.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(Ff6.this, Ff7.class);
		...
		kedepan.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(Ff6.this,Ff5.class);
			 ...
			 public void onClick(View v )
			   {
				...
				Intent i = new Intent(Ff6.this,Kombinasi_getlogik.class);

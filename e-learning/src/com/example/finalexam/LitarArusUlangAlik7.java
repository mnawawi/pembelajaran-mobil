...
public class LitarArusUlangAlik7 extends Activity implements OnClickListener {
	...
	//	wv.getSettings().setBuiltInZoomControls(true);
		...
		String data = "<body>" + "<img src=\"images/aras2_7.jpg\"/></body>";
		...
		menu.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(LitarArusUlangAlik7.this, Menu_Utama.class);
		...
		aras.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(LitarArusUlangAlik7.this, Aras2.class);
		...
		kedepan.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(LitarArusUlangAlik7.this,LitarArusUlangAlik8.class);
		...
		kebelakang.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(LitarArusUlangAlik7.this,LitarArusUlangAlik6.class);

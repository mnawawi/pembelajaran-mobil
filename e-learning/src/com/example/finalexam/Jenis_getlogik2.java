...
public class Jenis_getlogik2 extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.jenis_getlogik2);
	...
	//	wv.getSettings().setBuiltInZoomControls(true);
		...
		String data = "<body>" + "<img src=\"images/getlogik4.jpg\"/></body>";
		...
		menu.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(Jenis_getlogik2.this, Menu_Utama.class);
		...
		aras.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(Jenis_getlogik2.this, Aras1.class);
			 ...
			 public void onClick(View v )
			   {
				...
				Intent i = new Intent(Jenis_getlogik2.this,Jenis_getlogik1.class);

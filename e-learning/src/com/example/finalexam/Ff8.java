...
public class Ff8 extends Activity implements OnClickListener {
	...
	//	wv.getSettings().setBuiltInZoomControls(true);
		...
		String data = "<body>" + "<img src=\"images/ff8.jpg\"/></body>";
		...
		menu.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(Ff8.this, Menu_Utama.class);
		...
		aras.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(Ff8.this, Aras1.class);
			 ...
			 public void onClick(View v )
			   {
				...
				Intent i = new Intent(Ff8.this,Ff7.class);

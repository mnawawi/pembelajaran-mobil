...
public class LitarArusUlangAlik1 extends Activity implements OnClickListener {
	...
	//	wv.getSettings().setBuiltInZoomControls(true);
		...
		String data = "<body>" + "<img src=\"images/aras2_1.jpg\"/></body>";
		...
		menu.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(LitarArusUlangAlik1.this, Menu_Utama.class);
		...
		aras.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(LitarArusUlangAlik1.this, Aras2.class);
		...
		kedepan.setOnClickListener(new View.OnClickListener(){
			 ...
			 public void onClick(View v )
			   {
				Intent i = new Intent(LitarArusUlangAlik1.this,LitarArusUlangAlik2.class);
